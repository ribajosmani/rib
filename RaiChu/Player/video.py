...
IMAGE_THUMBNAIL = "https://telegra.ph/file/2ad9f3eeb5544500b48a6.jpg"
    ...
    if replied:
        if replied.video or replied.document:
            ...
            if len(m.command) < 2:
                await m.reply_photo(
                     photo=f"{IMG_6}",
                    caption="💬**Usage: /play Give a Title Song To Play Music or /vplay for Video Play Wixii Intaa Dheer laxariir @ribajosmani**"
                    ,
                      reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🦅 Channel", url=f"https://t.me/teamosmani"),
        ...
        if len(m.command) < 2:
            await m.reply_photo(
                     photo=f"{IMG_6}",
                    caption="💫**Usage: /play Give a Title Song To Play Music or /vplay for Video Play 𝐰𝐢𝐱𝐢𝐢 𝐢𝐧𝐭𝐚𝐚 𝐝𝐡𝐞𝐞𝐫 𝐥𝐚𝐱𝐚𝐫𝐢𝐢𝐫 @ribajosmani**"
                    ,
                      reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🦅 Channel", url=f"https://t.me/meribaj"),
                            InlineKeyboardButton("🦅 Support", url=f"https://t.me/osmanigroupbot")
                        ],
                        [
                            InlineKeyboardButton("🗑 Close", callback_data="cls")
